...
<c:set var="ctxName" value="${pageContext.request.servletContext.contextPath}"></c:set>
<header id="header">
        <div class="content-wrapper">
            <h1 id="logo"><a href="${ctxName}/index.jsp"><img src="${ctxName}/images/logo.png" alt="뉴렉처 온라인" /></a></h1>
            <section class="header-item-container">
                ...
                <nav id="member-menu">
                    ...
                    <ul class="clearfix">
                        ...
                        <c:if test="${empty uid }">
                        	<a class="member-menu-item-text" href="${ctxName}/joinus/login.jsp">로그인</a></li>
                        </c:if>
                        <c:if test="${not empty uid }">
                        	<a class="member-menu-item-text" href="${ctxName}/joinus/LogoutProc.jps">로그아웃</a></li>
                        </c:if>
                ...
                <nav id="my-menu">
                    ...
                    <ul class="clearfix">
                        ...
                        <li class="my-menu-item"><a class="my-menu-item-text" href="customer/notice.jsp"><img src="${ctxName}/images/txt-customer.png" alt="고객센터" /></a></li>
                    </ul>
                </nav>
            </section>
        </div>
